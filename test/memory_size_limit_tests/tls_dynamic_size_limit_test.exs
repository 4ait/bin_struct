defmodule BinStructTest.MemorySizeLimitTests.TlsDynamicSizeLimitTest do
  use ExUnit.Case
  ...
  test "tls receive dynamic size limit works", %{port: port} do
    # Enable BinStruct TLS helpers and set max buffer to 1MB
