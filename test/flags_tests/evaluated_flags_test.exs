defmodule BinStructTest.Flags.EvaluatedFlagsTest do

  use ExUnit.Case

  defmodule EvaluatedFlagsValuesBinStruct do
  ...
  test "struct with evaluated flag values works" do
    ...
    struct =
      EvaluatedFlagsValuesBinStruct.new(
        flags: flags
      )


    dump = EvaluatedFlagsValuesBinStruct.dump_binary(struct)

    { :ok, parsed_struct } = EvaluatedFlagsValuesBinStruct.parse_exact(dump)

    values = EvaluatedFlagsValuesBinStruct.decode(parsed_struct)
