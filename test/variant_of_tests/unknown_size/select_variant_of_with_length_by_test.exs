defmodule BinStructTest.VariantOfTests.UnknownSize.SelectVariantOfWithLengthByTest do
  ...
  defmodule StructWithVariant do
    ...
    }, select_variant_by: &select_variant_callback/1, length_by: &length_by/1
