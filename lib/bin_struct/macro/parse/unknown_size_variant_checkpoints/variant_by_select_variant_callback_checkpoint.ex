defmodule BinStruct.Macro.Parse.UnknownSizeVariantCheckpoints.VariantBySelectVariantCallbackCheckpoint do
  ...
  def variant_by_select_variant_callback_checkpoint(
        variants,
        select_variant_by,
        field,
        function_name,
