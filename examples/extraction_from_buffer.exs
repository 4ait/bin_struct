#Our goal is this example is extract values from binary buffer where data can be in any order
...
#Main goal of this example is tell: you are not alone, if hard time will come lib will cover your back no problem.
